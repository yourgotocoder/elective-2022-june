...
const ElectiveSelection = (props: Props) => {
    ...
    return (
        <div className={styles["main-grid"]}>
            ...
            <div className={styles["info-section"]}>
                <div className={styles["info-card"]}>
                    ...
                    <span style={{ fontSize: "0.7rem" }}>
                        **The higher your CGPA, the more likely you are to get
                        your preferred subject <br />
                        Option 1 will have highest priority in the allotment for
                        each elective.
                    </span>
                    {userData && !userData.cgpa && (
            ...
            <div className={styles["selection-data-section"]}>Section</div>
        </div>
    );
};
