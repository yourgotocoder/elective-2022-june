          ...
          <>
            <div className={styles["info-section"]}>
              <div className={styles["info-card"]}>
                ...
                <p>
                  <span style={{ color: "black" }}>Registration no:</span>{" "}
                  {userData?.regNo}
                </p>
                ...
                <span style={{ fontSize: "0.7rem" }}>
                  **The higher your CGPA, the more likely you are to get your
                  preferred subject <br />
                  Option 1 will have highest priority in the allotment for each
                  elective.
                </span>
                {userData && !userData.cgpa && (
                  <span
            ...
            <div className={styles["main-section"]}>
                ...
                <div className={styles["selection-data-section"]}>
                  <div>
                    ...
                    <ol className={styles["list-element-data"]}>
                      {userData.elective_selections.first.option1_1 !== "" && (
                        <li>{userData.elective_selections.first.option1_1}</li>
                      )}
                      {userData.elective_selections.first.option1_2 !== "" && (
                        <li>{userData.elective_selections.first.option1_2}</li>
                      )}
                      {userData.elective_selections.first.option1_3 !== "" && (
                        <li>{userData.elective_selections.first.option1_3}</li>
                      )}
                      {userData.elective_selections.first.option1_4 !== "" && (
                        <li>{userData.elective_selections.first.option1_4}</li>
                      )}
                    </ol>
                    <p
                      style={{
                  ...
                  <div>
                    ...
                    <ol className={styles["list-element-data"]}>
                      {userData.elective_selections.second.option2_1 !== "" && (
                        <li>{userData.elective_selections.second.option2_1}</li>
                      )}
                      {userData.elective_selections.second.option2_2 !== "" && (
                        <li>{userData.elective_selections.second.option2_2}</li>
                      )}
                      {userData.elective_selections.second.option2_3 !== "" && (
                        <li>{userData.elective_selections.second.option2_3}</li>
                      )}
                      {userData.elective_selections.second.option2_4 !== "" && (
                        <li>{userData.elective_selections.second.option2_4}</li>
                      )}
                    </ol>
                    <p
                      style={{
                  ...
                  {userData && userData.current_sem === 7 && (
                    <div>
                      ...
                      <ol className={styles["list-element"]}>
                        {userData.elective_selections.third.option3_1 !==
                          "" && (
                          <li>
                            {userData.elective_selections.third.option3_1}
                          </li>
                        )}
                        {userData.elective_selections.third.option3_2 !==
                          "" && (
                          <li>
                            {userData.elective_selections.third.option3_2}
                          </li>
                        )}
                        {userData.elective_selections.third.option3_3 !==
                          "" && (
                          <li>
                            {userData.elective_selections.third.option3_3}
                          </li>
                        )}
                        {userData.elective_selections.third.option3_4 !==
                          "" && (
                          <li>
                            {userData.elective_selections.third.option3_4}
                          </li>
                        )}
                        {userData.elective_selections.third.option3_5 !==
                          "" && (
                          <li>
                            {userData.elective_selections.third.option3_5}
                          </li>
              ...
              {userData && !userData.elective_selections && !submitted && (
                      ...
                      >
                        <FormControl fullWidth>
                          ...
                          <Select
                            ...
                            label="Option 1"
                            value={option1_1}
                            onChange={(e) => handleChange(e, "option1_1")}
                          >
                            {optionList1?.map((option, index) => (
                              <MenuItem
                                value={option}
                                key={index}
                                disabled={disable_option_1(option)}
                              >
                                {option}
                              </MenuItem>
                            ))}
                        ...
                        >
                          <FormControl fullWidth>
                            ...
                            <Select
                              ...
                              label="Option 2"
                              value={option1_2}
                              onChange={(e) => handleChange(e, "option1_2")}
                            >
                              {optionList1?.map((option, index) => (
                                <MenuItem
                                  value={option}
                        ...
                        >
                          <FormControl fullWidth>
                            ...
                            <Select
                              ...
                              label="Option 3"
                              value={option1_3}
                              onChange={(e) => handleChange(e, "option1_3")}
                            >
                              {optionList1?.map((option, index) => (
                                <MenuItem
                                  value={option}
                        ...
                        >
                          <FormControl fullWidth>
                            ...
                            <Select
                              ...
                              label="Option 4"
                              value={option1_4}
                              onChange={(e) => handleChange(e, "option1_4")}
                            >
                              {optionList1?.map((option, index) => (
                                <MenuItem
                                  value={option}
                        ...
                        >
                          <FormControl fullWidth>
                            ...
                            <Select
                              ...
                              label="Option 5"
                              value={option1_5}
                              onChange={(e) => handleChange(e, "option1_5")}
                            >
                              {optionList1?.map((option, index) => (
                                <MenuItem
                                  value={option}
                        ...
                        <div>
                          <Button
                            ...
                            disabled={
                              option1_1 === "" ||
                              option1_2 === "" ||
                              (optionList1.length > 2 && option1_3 === "") ||
                              (optionList1.length > 3 && option1_4 === "")
                            }
                            onClick={handleNext}
                            sx={{
                              mt: 1,
                      ...
                      >
                        <FormControl fullWidth>
                          ...
                          <Select
                            ...
                            label="Option 1"
                            value={option2_1}
                            onChange={(e) => handleChange(e, "option2_1")}
                          >
                            {optionList2?.map((option, index) => (
                              <MenuItem
                                value={option}
                                key={index}
                                disabled={disable_option_2(option)}
                              >
                                {option}
                              </MenuItem>
                            ))}
                        ...
                        >
                          <FormControl fullWidth>
                            ...
                            <Select
                              ...
                              label="Option 2"
                              value={option2_2}
                              onChange={(e) => handleChange(e, "option2_2")}
                            >
                              {optionList2?.map((option, index) => (
                                <MenuItem
                                  value={option}
                        ...
                        >
                          <FormControl fullWidth>
                            ...
                            <Select
                              ...
                              label="Option 3"
                              value={option2_3}
                              onChange={(e) => handleChange(e, "option2_3")}
                            >
                              {optionList2?.map((option, index) => (
                                <MenuItem
                                  value={option}
                        ...
                        >
                          <FormControl fullWidth>
                            ...
                            <Select
                              ...
                              label="Option 4"
                              value={option2_4}
                              onChange={(e) => handleChange(e, "option2_4")}
                            >
                              {optionList2?.map((option, index) => (
                                <MenuItem
                                  value={option}
                        ...
                        >
                          <FormControl fullWidth>
                            ...
                            <Select
                              ...
                              label="Option 5"
                              value={option2_5}
                              onChange={(e) => handleChange(e, "option2_5")}
                            >
                              {optionList2?.map((option, index) => (
                                <MenuItem
                                  value={option}
                        ...
                        <div>
                          <Button
                            ...
                            disabled={
                              option2_1 === "" ||
                              option2_2 === "" ||
                              (optionList2.length > 2 && option2_3 === "") ||
                              (optionList2.length > 3 && option2_4 === "")
                            }
                          >
                            Continue
                          </Button>
                        ...
                        >
                          <FormControl fullWidth>
                            ...
                            <Select
                              ...
                              label="Option 1"
                              value={option3_1}
                              onChange={(e) => handleChange(e, "option3_1")}
                            >
                              {userData &&
                                userData.open_elective_options!.map(
                                  (option, index) => (
                                    <MenuItem
                                      value={option}
                                      key={index}
                                      disabled={disable_option_3(option)}
                                    >
                                      {option}
                                    </MenuItem>
                                  )
                        ...
                        >
                          <FormControl fullWidth>
                            ...
                            <Select
                              ...
                              label="Option 2"
                              value={option3_2}
                              onChange={(e) => handleChange(e, "option3_2")}
                            >
                              {userData &&
                                userData.open_elective_options!.map(
                                  (option, index) => (
                        ...
                        >
                          <FormControl fullWidth>
                            ...
                            <Select
                              ...
                              label="Option 3"
                              value={option3_3}
                              onChange={(e) => handleChange(e, "option3_3")}
                            >
                              {userData &&
                                userData.open_elective_options!.map(
                                  (option, index) => (
                        ...
                        >
                          <FormControl fullWidth>
                            ...
                            <Select
                              ...
                              label="Option 4"
                              value={option3_4}
                              onChange={(e) => handleChange(e, "option3_4")}
                            >
                              {userData &&
                                userData.open_elective_options!.map(
                                  (option, index) => (
                        ...
                        >
                          <FormControl fullWidth>
                            ...
                            <Select
                              ...
                              label="Option 5"
                              value={option3_5}
                              onChange={(e) => handleChange(e, "option3_5")}
                            >
                              {userData &&
                                userData.open_elective_options!.map(
                                  (option, index) => (
            ...
            {userData && !userData.elective_selections && (
              <div className={styles["selection-data-section"]}>
                <div>
                  ...
                  <ol className={styles["list-element"]}>
                    {option1_1 !== "" && <li>{option1_1}</li>}
                    {option1_2 !== "" && <li>{option1_2}</li>}
                    {option1_3 !== "" && <li>{option1_3}</li>}
                    {option1_4 !== "" && <li>{option1_4}</li>}
                  </ol>
                  <p
                    style={{
                      color: "gray",
                ...
                <div>
                  ...
                  <ol className={styles["list-element"]}>
                    {option2_1 !== "" && <li>{option2_1}</li>}
                    {option2_2 !== "" && <li>{option2_2}</li>}
                    {option2_3 !== "" && <li>{option2_3}</li>}
                    {option2_4 !== "" && <li>{option2_4}</li>}
                  </ol>
                  <p
                    style={{
                      color: "gray",
                ...
                {userData && userData.current_sem === 7 && (
                  <div>
                    ...
                    <ol className={styles["list-element"]}>
                      {option3_1 !== "" && <li>{option3_1}</li>}
                      {option3_2 !== "" && <li>{option3_2}</li>}
                      {option3_3 !== "" && <li>{option3_3}</li>}
                      {option3_4 !== "" && <li>{option3_4}</li>}
                      {option3_5 !== "" && <li>{option3_5}</li>}
                    </ol>
                    <p
                      style={{
                        color: "gray",
